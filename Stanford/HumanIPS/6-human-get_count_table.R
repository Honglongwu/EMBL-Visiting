...
bam = dir(file.path(folder, "HumanIPS"),pattern=".*.bam$", full.names=TRUE)
...
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts,file=file.path(folder, "HumanIPS/Counts-Human-iPS.rda"))
