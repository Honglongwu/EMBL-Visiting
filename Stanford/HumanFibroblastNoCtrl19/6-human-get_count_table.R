...
bam = dir(file.path(folder, "HumanFibroblast"),pattern=".*.bam$", full.names=TRUE)
...
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts,file=file.path(folder, "Counts-Human-Fibroblast.rda"))
