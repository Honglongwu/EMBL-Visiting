...
write.table(out, file = 'NGLY1-Genes-Correlation-iPS.txt', sep = '\t', quote=F, row.names=F, col.names=F)
...
write.table(out, file = 'NGLY1-Genes-Correlation-NPC.txt', sep = '\t', quote=F, row.names=F, col.names=F)
