...
load(file.path(folder,'HumanLymphoblastNoCtrl/SampleAnnot-CP1CP3CP1Ctrl.rda'))
...
lattice::dotplot(gn~individual,group=sampleStatus,data=data, auto.key=T, pch=19, ylab="Normalized Gene Expression",xlab=gene) 
dev.off()
}
