...
lattice::dotplot(mat.sf["ENSMUSG00000021785",]~sampleAnnot$sample|sampleAnnot$passage, labels=sampleAnnot$sample, auto.key=TRUE,pch=19, ylab="Gene Expression",main="NGLY1")
dev.off()
