...
sampleAnnot$sample = factor(rep(c("Ngly1-KO","WT"),each=3), levels = c("WT","Ngly1-KO"))
...
{
pdf(file.path(folder, paste0('/5-geneCheck/Mouse-2014_11_10_',gene,'-Normalized-Expression.pdf')))
