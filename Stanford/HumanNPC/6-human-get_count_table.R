...
bam = dir(file.path(folder, "HumanNPC"),pattern=".*.bam$", full.names=TRUE)
...
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts,file=file.path(folder, "HumanNPC/Counts-Human-NPC.rda"))
