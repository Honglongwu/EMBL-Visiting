...
bamLst = BamFileList( dir(file.path(folder, "MouseImmortP5"),pattern=".*(primary|immort).*.bam$", full.names=TRUE), yieldSize=100000)
...
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts, file=file.path(folder, "MouseImmortP5/Counts-Mouse-immortP5.rda"))
