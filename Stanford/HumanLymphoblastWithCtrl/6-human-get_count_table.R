...
bam = dir(file.path(folder, "HumanLymphoblast"),pattern=".*.bam$", full.names=TRUE)
...
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts,file=file.path(folder, "Counts-Human-Lymphoblast.rda"))
