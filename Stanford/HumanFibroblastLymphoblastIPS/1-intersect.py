...
inF2 = 'deIPS_sig_proteincoding_down.txt'
ouF = 'Human-Fibroblast-Lymphoblast-IPS-sig-proteincoding-down.txt'
intersect(inF1, inF2, ouF)

inF1 = 'Human-Fibroblast-Lymphoblast-sig-proteincoding-up.txt'
inF2 = 'deIPS_sig_proteincoding_up.txt'
ouF = 'Human-Fibroblast-Lymphoblast-IPS-sig-proteincoding-up.txt'
intersect(inF1, inF2, ouF)
