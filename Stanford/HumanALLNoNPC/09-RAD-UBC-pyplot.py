...
df = pd.read_table('NGLY1-RADUBC-Family.txt')
...
AX[3].set_yticks([2000,4000,6000,8000])	
AX[6].set_yticks([2000,4000,6000,8000])	
AX[9].set_yticks([2000,4000])	
AX[12].set_yticks([1000,2000])	
AX[15].set_yticks([500,1000])	
AX[9].text(-1.85,0,'Normalized gene expression', rotation='vertical',verticalalignment='center')

pl.savefig('NGLY1-RADUBC-Normalized-Human.pdf')
ouFile.close()
