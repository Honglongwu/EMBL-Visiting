...
bamLst = BamFileList( dir(file.path(folder, "MousePrimaryP4/ENGaseKO-DoubleKO"),pattern=".*(primary|immort).*.bam$", full.names=TRUE), yieldSize=100000)
...
#save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts,  pd, file=file.path(folder, "Counts-Mouse-2014-1011-3.rda"))
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts, file=file.path(folder, "MousePrimaryP4/ENGaseKO-DoubleKO/Counts-Mouse-DoubleKO_WT-primaryP4.rda"))
