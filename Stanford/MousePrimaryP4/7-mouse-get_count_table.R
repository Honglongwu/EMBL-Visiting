...
bamLst = BamFileList( dir(file.path(folder, "MousePrimaryP4"),pattern=".*(primary|immort).*.bam$", full.names=TRUE), yieldSize=100000)
...
save(exonsByGene, intronsByGene, geneCounts, exonCounts, intronCounts, file=file.path(folder, "Counts-Mouse-primaryP4.rda"))
