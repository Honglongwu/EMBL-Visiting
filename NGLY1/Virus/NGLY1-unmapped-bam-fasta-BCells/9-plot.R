...
pdf("NGLY1-Virus-B-Cells2.pdf")
qplot(x=factor(Sample, levels=c('CP1-B','CP3-B','MCP1-B','Ctrl-B')), y=Count, fill=virus,data=data, geom="bar", stat="identity",position="dodge",xlab="Sample of B cells", ylab="Number of reads")
dev.off()
