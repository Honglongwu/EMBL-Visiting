...
bcftools view MCP1_AzaC_20uM_biorep2.raw.vcf |/g/steinmetz/hsun/MySoft/samtools/samtools-0.1.19/bcftools/vcfutils.pl varFilter - > MCP1_AzaC_20uM_biorep2.flt.vcf
