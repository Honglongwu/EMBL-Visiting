...
plotFolder=file.path("/g/steinmetz/hsun/NGLY1/Han-NGLY1/MYC-Link", "single-gene-plot-check")
...
genes=read.table('DE_six_samples_MYC.txt',header=F)
pdf(file.path(plotFolder, 'MYC_drug_effect_six_samples.pdf'), width=8, height=6)
geneplot(genes[,2])
dev.off()
