myc=read.table('MYC-partners-700',header=F)
...
write.table(myc_six_id, 'DE_six_samples_MYC-700.txt',quote=F,col.names=F, row.names=F)
write.table(myc_four_id, 'DE_four_samples_MYC-700.txt',quote=F,col.names=F, row.names=F)
