...
fls <- list.files('/g/steinmetz/hsun/NGLY1/NGLY1-wmueller/alignment_filtered/B-Cells',
...
save(count, count.assay, file='ENSG00000151092-GRCh37-transcripts-unique-region2-counts-Bcells.rda')
write.table(count.assay,file = 'ENSG00000151092-GRCh37-transcripts-unique-region2-counts-Bcells.txt',quote=F,col.names=NA)
