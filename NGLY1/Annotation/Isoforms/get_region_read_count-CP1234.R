...
olap <- summarizeOverlaps(features, bfl, ignore.strand=TRUE, singleEnd = TRUE)
save(assay(olap), 'ENSG00000151092-GRCh37-transcripts-unique-region2-counts-CP1234.rda')
