...
genes = ids[ids$gene_id %in% two_sets,]
write.table(genes,'DE_ngly1_twosets_genes.txt',quote=F,row.names=F, col.names=F)
write.table(genes[1],'DE_ngly1_twosets_genes_id.txt',quote=F,row.names=F, col.names=F)
write.table(genes[2],'DE_ngly1_twosets_genes_symbol.txt',quote=F,row.names=F, col.names=F)
