...
write.table( res, file=file.path(outfolder, "DMSO-ALL.txt"), quote = FALSE, sep = "\t",  row.names = T, col.names=NA)

rld = rlog(dds, blind=FALSE)
save(dds, rld, res,sampleAnnot,file=file.path(outfolder, "resNGLY1-ALL.rda"))

pdf(file.path(outfolder, "plot_PCA-DMSO-ALL.pdf"), width=8, height=6)
